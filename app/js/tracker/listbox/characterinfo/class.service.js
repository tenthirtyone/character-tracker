    ...
    var classes = [
      ...
      {name: 'Bard', 
       ...
       progression: [
         ...
         {level: 16, proficiency: 5, features: ['Ability Score Improvement'],
          spells: {cantrips: 4, known: 19, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 2}, {sixth: 1}, {seventh: 1}, {eigth: 1}]}},
         {level: 17, proficiency: 6, features: ['Song of Rest d12'],
          spells: {cantrips: 4, known: 20, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 2}, {sixth: 1}, {seventh: 1}, {eigth: 1}, {ninth: 1}]}},
         {level: 18, proficiency: 6, features: ['Magical Secrets'],
          spells: {cantrips: 4, known: 22, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 2}, {sixth: 1}, {seventh: 1}, {eigth: 1}, {ninth: 1}]}},
         {level: 19, proficiency: 6, features: ['Ability Score Improvement'],
          spells: {cantrips: 4, known: 22, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 2}, {sixth: 2}, {seventh: 1}, {eigth: 1}, {ninth: 1}]}},
         {level: 20, proficiency: 6, features: ['Superior Inspiration'],
          spells: {cantrips: 4, known: 22, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 2}, {sixth: 2}, {seventh: 2}, {eigth: 1}, {ninth: 1}]}},
       ]
      },
      {name: 'Cleric', 
       hitdice: 8, 
       ...
       progression: [
         ...
         {level: 16, proficiency: 5, features: ['Ability Score Improvement'],
          spells: {cantrips: 5, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 2}, {sixth: 1}, {seventh: 1}, {eigth: 1}]}},
         {level: 17, proficiency: 6, features: ['Destroy Undead CR 4', 'Divine Domain Feature'],
          spells: {cantrips: 5, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 2}, {sixth: 1}, {seventh: 1}, {eigth: 1}, {ninth: 1}]}},
         {level: 18, proficiency: 6, features: ['Channel Divinity 3'],
          spells: {cantrips: 5, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 3}, {sixth: 1}, {seventh: 1}, {eigth: 1}, {ninth: 1}]}},
         {level: 19, proficiency: 6, features: ['Ability Score Improvement'],
          spells: {cantrips: 5, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 3}, {sixth: 2}, {seventh: 1}, {eigth: 1}, {ninth: 1}]}},
         {level: 20, proficiency: 6, features: ['Divine Intervention Improvement'],
          spells: {cantrips: 5, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 3}, {sixth: 2}, {seventh: 2}, {eigth: 1}, {ninth: 1}]}},
       ]
      },
      {name: 'Druid', 
       hitdice: 8, 
       ...
       progression: [
         ...
         {level: 16, proficiency: 5, features: ['Ability Score Improvement'],
          spells: {cantrips: 4, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 2}, {sixth: 1}, {seventh: 1}, {eigth: 1}]}},
         {level: 17, proficiency: 6, features: ['None'],
          spells: {cantrips: 4, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 2}, {sixth: 1}, {seventh: 1}, {eigth: 1}, {ninth: 1}]}},
         {level: 18, proficiency: 6, features: ['Timeless Body', 'Beast Spells'],
          spells: {cantrips: 4, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 3}, {sixth: 1}, {seventh: 1}, {eigth: 1}, {ninth: 1}]}},
         {level: 19, proficiency: 6, features: ['Ability Score Improvement'],
          spells: {cantrips: 4, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 3}, {sixth: 2}, {seventh: 1}, {eigth: 1}, {ninth: 1}]}},
         {level: 20, proficiency: 6, features: ['Archdruid'],
          spells: {cantrips: 4, slots: [{first: 4}, {second: 3}, {third: 3}, {fourth: 3}, {fifth: 3}, {sixth: 2}, {seventh: 2}, {eigth: 1}, {ninth: 1}]}},
       ]
      },
      {name: 'Fighter', 
       hitdice: 10, 
      ...
      {name: 'Warlock', 
       ...
       progression: [
         {level: 1, proficiency: 2, features: ['Otherwordly Patron', 'Pact Magic'],
          spells: {cantrips: 0, known: 0, slots: 0, level: 'first', invocations: 0}},
         ...
         {level: 6, proficiency: 3, features: ['Otherwordly Patron Feature'],
          spells: {cantrips: 0, known: 0, slots: 0, level: 'first', invocations: 0}},
         {level: 7, proficiency: 3, features: [''],
          spells: {cantrips: 0, known: 0, slots: 0, level: 'first', invocations: 0}},
         {level: 8, proficiency: 3, features: ['Ability Score Improvement'],
          spells: {cantrips: 0, known: 0, slots: 0, level: 'first', invocations: 0}},
         {level: 9, proficiency: 4, features: ['None'],
